	...
	return (
		<div className="flex flex-col items-center justify-center gap-10 px-6 py-10 md:px-10">
			<div className="p-4 text-center lg:hidden">
				<h2 className="text-xl font-semibold">Content not available</h2>
				<p className="mt-2 text-muted-foreground">Please use a larger screen (1024px or wider) to access this page.</p>
			</div>
			<div className="hidden items-center justify-center gap-10 lg:flex lg:flex-col">
